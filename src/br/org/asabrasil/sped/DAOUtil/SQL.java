...
public final class SQL {
	...
	public static StringBuilder consultaRegistroJ050() {

		StringBuilder sql = new StringBuilder();

		sql.append(" SELECT NATUREZA_CONTA_GRUPO, INDICADOR, NIVEL, CONTA_ANALITICA, CONTA_SINTETICA, NOME_CONTA FROM (                                                              ");
		sql.append("                          SELECT CASE WHEN CONTA_1.CLASSIFICADOR LIKE '1%' THEN '01' ELSE                                                                        ");
...
//	
	...
	public static StringBuilder consultaRegistroK155(){
		...
		sql.append("   SELECT S1.CREDITOPLANO Plano, S1.CREDITOUNIDADE Unidade, 0 AS ValorDebito, Sum(valor) AS ValorCredito                                                     ");
		sql.append("   FROM ASASIGA1.LANCAMENTO S1                                                                                                                               ");
		sql.append("   WHERE S1.DATA >= :dtInicial AND S1.DATA <= '31122015' AND S1.CREDITOPLANO IS NOT NULL  AND S1.DEBITOPLANO IS NULL                                         ");
		sql.append("   GROUP BY  S1.CREDITOUNIDADE, S1.DEBITOPLANO, S1.CREDITOPLANO                                                                                              ");
		sql.append("   UNION ALL                                                                                                                                                 ");
		sql.append("   SELECT S2.DEBITOPLANO Plano, S2.DEBITOUNIDADE Unidade, Sum(valor) AS ValorDebito, 0 AS ValorCredito                                                       ");
		sql.append("   FROM ASASIGA1.LANCAMENTO S2                                                                                                                               ");
		sql.append("   WHERE S2.DATA >= :dtInicial AND S2.DATA <= '31122015' AND S2.DEBITOPLANO IS NOT NULL AND S2.CREDITOPLANO IS NULL                                          ");
		sql.append("   GROUP BY  S2.DEBITOUNIDADE, S2.DEBITOPLANO, S2.CREDITOPLANO                                                                                               ");
		sql.append("   UNION all                                                                                                                                                 ");
		sql.append("   SELECT Plano, Unidade, Sum(VALORCREDITO) VALORCREDITO, Sum(VALORDEBITO) VALORDEBITO FROM (                                                                ");
		sql.append("   SELECT Plano, Unidade, Sum(VALORCREDITO) VALORCREDITO, Sum(VALORDEBITO) VALORDEBITO FROM (                                                                ");
		...
		sql.append("   ON CONTAPAGARDETALHE.UNIDADE = REGISTRODEBITOCONTABILIZADO.UNIDADE AND CONTAPAGARDETALHE.CONTAPAGAR = REGISTRODEBITOCONTABILIZADO.CONTAPAGAR              ");
		sql.append("   AND CONTAPAGARDETALHE.ID = REGISTRODEBITOCONTABILIZADO.CONTAPAGARDETALHE                                                                                  ");
		sql.append("   WHERE PAGAMENTO.DATABAIXA >= :dtInicial AND PAGAMENTO.DATABAIXA <= '31122015' AND PAGAMENTO.DATAESTORNO IS NULL                                           ");
		sql.append("   ) GROUP BY plano, unidade                                                                                                                                 ");
		sql.append("   UNION                                                                                                                                                     ");
		sql.append("   SELECT PLANO, UNIDADE, SUM(VALORCREDITO) VALORCREDITO, SUM(VALORDEBITO) VALORDEBITO FROM (                                                                ");
		sql.append("   SELECT LANCAMENTO.CREDITOPLANO Plano, REGISTRODEBITOCONTABILIZADO.UNIDADE, 0 VALORCREDITO, CONTAPAGARDETALHE.VALOR VALORDEBITO                            ");
		...
		sql.append("   INNER JOIN ASASIGA1.LANCAMENTO                                                                                                                            ");
		sql.append("   ON LANCAMENTO.UNIDADEOWNER = REGISTROCREDITOCONTABILIZADO.UNIDADE AND LANCAMENTO.ID = REGISTROCREDITOCONTABILIZADO.LANCAMENTOCREDITO                      ");
		sql.append("   WHERE RECEBIMENTO.DATABAIXA >= :dtInicial AND RECEBIMENTO.DATABAIXA <= '31122015' AND RECEBIMENTO.DATAESTORNO IS NULL                                     ");
		sql.append("   ) GROUP BY plano, unidade                                                                                                                                 ");
		sql.append("   UNION                                                                                                                                                     ");
		sql.append("   SELECT PLANO, UNIDADE, SUM(VALORCREDITO) VALORCREDITO, SUM(VALORDEBITO) VALORDEBITO FROM (                                                                ");
		sql.append("   SELECT LANCAMENTO.CREDITOPLANO PLANO, REGISTROCREDITOCONTABILIZADO.UNIDADE, VALOR VALORCREDITO, 0 VALORDEBITO                                             ");
		...
		sql.append("   SELECT  S2.DEBITOPLANO PLANO,S2.UNIDADEOWNER Unidade, VALOR AS VALORCREDITO, 0 AS VALORDEBITO                                                             ");
		sql.append("   FROM ASASIGA1.LANCAMENTO S2                                                                                                                               ");
		sql.append("   WHERE S2.TIPO = '1' AND S2.DATA >= :dtInicial AND S2.DATA <= '31122015' AND S2.DEBITOPLANO IS NOT NULL AND S2.CREDITOPLANO IS NOT NULL                    ");
		sql.append("   ) GROUP BY plano, unidade                                                                                                                                 ");
		sql.append("   UNION                                                                                                                                                     ");
		sql.append("   SELECT Plano, Unidade, Sum(VALORCREDITO) VALORCREDITO, Sum(VALORDEBITO) VALORDEBITO FROM (                                                                ");
		sql.append("   SELECT  S2.CREDITOPLANO PLANO,S2.UNIDADEOWNER unidade, 0 AS VALORCREDITO, VALOR AS VALORDEBITO                                                            ");
		...
		sql.append("   ON LANCAMENTO.UNIDADEOWNER = TRANSACAOFINANCEIRA.UNIDADE AND LANCAMENTO.ID = TRANSACAOCONTABILIZADA.LANCAMENTOTRANSACAO                                   ");
		sql.append("   AND LANCAMENTO.DATA = TRANSACAOFINANCEIRA.DATA                                                                                                            ");
		sql.append("   WHERE TRANSACAOFINANCEIRA.DATA >= :dtInicial  AND TRANSACAOFINANCEIRA.DATA <= '31122015'                                                                  ");
		sql.append("   ) GROUP BY plano, unidade                                                                                                                                 ");
		sql.append("   UNION                                                                                                                                                     ");
		sql.append("   SELECT Plano, Unidade, Sum(VALORCREDITO) VALORCREDITO, Sum(VALORDEBITO) VALORDEBITO FROM (                                                                ");
		sql.append("   SELECT DISTINCT TRANSACAOFINANCEIRA.DATA, TRANSACAOFINANCEIRA.ID LANCAMENTO, TRANSACAOFINANCEIRA.DOCUMENTO,  LANCAMENTO.CREDITOPLANO PLANO,               ");
		...
		sql.append("   SELECT S1.CREDITOPLANO Plano, S1.CREDITOUNIDADE Unidade, 0 AS ValorDebito, Sum(valor) AS ValorCredito                                                     ");
		sql.append("   FROM ASASIGA1.LANCAMENTO S1                                                                                                                               ");
		sql.append("   WHERE S1.DATA >= '01011990' AND S1.DATA < :dtInicial AND S1.CREDITOPLANO IS NOT NULL  AND S1.DEBITOPLANO IS NULL                                          ");
		sql.append("   GROUP BY  S1.CREDITOUNIDADE, S1.DEBITOPLANO, S1.CREDITOPLANO                                                                                              ");
		sql.append("   UNION ALL                                                                                                                                                 ");
		sql.append("   SELECT S2.DEBITOPLANO Plano, S2.DEBITOUNIDADE Unidade, Sum(valor) AS ValorDebito, 0 AS ValorCredito                                                       ");
		sql.append("   FROM ASASIGA1.LANCAMENTO S2                                                                                                                               ");
		sql.append("   WHERE S2.DATA >= '01011990' AND S2.DATA < :dtInicial AND S2.DEBITOPLANO IS NOT NULL AND S2.CREDITOPLANO IS NULL                                           ");
		sql.append("   GROUP BY  S2.DEBITOUNIDADE, S2.DEBITOPLANO, S2.CREDITOPLANO                                                                                               ");
		sql.append("   ) GROUP BY plano, unidade                                                                                                                                 ");
		sql.append("   UNION all                                                                                                                                                 ");
		sql.append("   SELECT Plano, Unidade, -Sum(VALORCREDITO) VALORCREDITO, -Sum(VALORDEBITO) VALORDEBITO FROM (                                                              ");
		...
		sql.append("   ON CONTAPAGARDETALHE.UNIDADE = REGISTRODEBITOCONTABILIZADO.UNIDADE AND CONTAPAGARDETALHE.CONTAPAGAR = REGISTRODEBITOCONTABILIZADO.CONTAPAGAR              ");
		sql.append("   AND CONTAPAGARDETALHE.ID = REGISTRODEBITOCONTABILIZADO.CONTAPAGARDETALHE                                                                                  ");
		sql.append("   WHERE PAGAMENTO.DATABAIXA >= '01011990' AND PAGAMENTO.DATABAIXA < :dtInicial AND PAGAMENTO.DATAESTORNO IS NULL                                            ");
		sql.append("   ) GROUP BY plano, unidade                                                                                                                                 ");
		sql.append("   UNION                                                                                                                                                     ");
		sql.append("   SELECT Plano, Unidade, Sum(VALORCREDITO) VALORCREDITO, Sum(VALORDEBITO) VALORDEBITO FROM (                                                                ");
		sql.append("   SELECT LANCAMENTO.CREDITOPLANO Plano, REGISTRODEBITOCONTABILIZADO.UNIDADE, 0 VALORCREDITO, CONTAPAGARDETALHE.VALOR VALORDEBITO                            ");
		...
		sql.append("   INNER JOIN ASASIGA1.LANCAMENTO                                                                                                                            ");
		sql.append("   ON LANCAMENTO.UNIDADEOWNER = REGISTROCREDITOCONTABILIZADO.UNIDADE AND LANCAMENTO.ID = REGISTROCREDITOCONTABILIZADO.LANCAMENTOCREDITO                      ");
		sql.append("   WHERE RECEBIMENTO.DATABAIXA >= '01011990' AND RECEBIMENTO.DATABAIXA < :dtInicial AND RECEBIMENTO.DATAESTORNO IS NULL                                      ");
		sql.append("   ) GROUP BY plano, unidade                                                                                                                                 ");
		sql.append("   UNION                                                                                                                                                     ");
		sql.append("   SELECT Plano, Unidade, Sum(VALORCREDITO) VALORCREDITO, Sum(VALORDEBITO) VALORDEBITO FROM (                                                                ");
		sql.append("   SELECT LANCAMENTO.CREDITOPLANO PLANO, REGISTROCREDITOCONTABILIZADO.UNIDADE, VALOR VALORCREDITO, 0 VALORDEBITO                                             ");
		...
		sql.append("   SELECT  S2.DEBITOPLANO PLANO,S2.UNIDADEOWNER Unidade, VALOR AS VALORCREDITO, 0 AS VALORDEBITO                                                             ");
		sql.append("   FROM ASASIGA1.LANCAMENTO S2                                                                                                                               ");
		sql.append("   WHERE S2.TIPO = '1' AND S2.DATA >= '01011990' AND S2.DATA < :dtInicial AND S2.DEBITOPLANO IS NOT NULL AND S2.CREDITOPLANO IS NOT NULL                     ");
		sql.append("   ) GROUP BY plano, unidade                                                                                                                                 ");
		sql.append("   UNION                                                                                                                                                     ");
		sql.append("   SELECT Plano, Unidade, Sum(VALORCREDITO) VALORCREDITO, Sum(VALORDEBITO) VALORDEBITO FROM (                                                                ");
		sql.append("   SELECT  S2.CREDITOPLANO PLANO,S2.UNIDADEOWNER unidade, 0 AS VALORCREDITO, VALOR AS VALORDEBITO                                                            ");
		sql.append("   FROM ASASIGA1.LANCAMENTO S2                                                                                                                               ");
		sql.append("   WHERE S2.TIPO = '1' AND S2.DATA >= '01011990' AND S2.DATA < :dtInicial AND DEBITOPLANO IS NOT NULL AND CREDITOPLANO IS NOT NULL                           ");
		sql.append("   ) GROUP BY plano, unidade                                                                                                                                 ");
		sql.append("   ) GROUP BY plano, unidade                                                                                                                                 ");
		sql.append("   UNION ALL                                                                                                                                                 ");
		sql.append("   SELECT Plano, Unidade, Sum(VALORCREDITO) VALORCREDITO, Sum(VALORDEBITO) VALORDEBITO FROM (                                                                ");
		...
		sql.append("   ON LANCAMENTO.UNIDADEOWNER = TRANSACAOFINANCEIRA.UNIDADE AND LANCAMENTO.ID = TRANSACAOCONTABILIZADA.LANCAMENTOTRANSACAO                                   ");
		sql.append("   AND LANCAMENTO.DATA = TRANSACAOFINANCEIRA.DATA                                                                                                            ");
		sql.append("   WHERE TRANSACAOFINANCEIRA.DATA >= '01011990' AND TRANSACAOFINANCEIRA.DATA < :dtInicial                                                                    ");
		sql.append("   ) GROUP BY plano, unidade                                                                                                                                 ");
		sql.append("   UNION                                                                                                                                                     ");
		sql.append("   SELECT Plano, Unidade, Sum(VALORCREDITO) VALORCREDITO, Sum(VALORDEBITO) VALORDEBITO FROM (                                                                ");
		sql.append("   SELECT DISTINCT TRANSACAOFINANCEIRA.DATA, TRANSACAOFINANCEIRA.ID LANCAMENTO, TRANSACAOFINANCEIRA.DOCUMENTO,  LANCAMENTO.CREDITOPLANO PLANO,               ");
